      ...
      <Container>
        <Flex className="items-center justify-between">
          <div ref={categoryRef} className="relative">
            ...
            {categoryMenuOpen && (
              <List
                className={`[&>*:nth-last-child(1)]:border-none w-[200px] sm:w-[230px] md:w-[263px] font-dm-sans capitalize bg-primary-color text-white !z-20 absolute left-0 top-[37px]`}
              >
                {categoryDropDownInfo.map((item) => (
                  ...
                  >
                    <Link
                      to={item.path}
                      className={
                        " py-3 md:py-4 px-5 text-[15px] border-b-[1px] border-gray-500 ease-in duration-200 opacity-75 hover:opacity-100 hover:text-white hover:pl-[25px] capitalize block"
                      }
                    >
                      {item.name}
                    </Link>
            ...
            >
              <div ref={accountRef} className={"relative z-10"}>
                ...
                {accountDropDownShow && (
                  <List
                    className={
                      "w-[150px] md:w-[200px] group font-dm-sans capitalize text-center bg-white border text-[#ada8a8] absolute top-[37px] right-0 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] [&>*:last-child]:border-none"
                    }
                  >
                    <ListItem
              ...
              <div ref={addToCartRef} className={"relative z-10"}>
                ...
                {addToCartShow && (
                  <div
                    className={`cart-box w-[280px] sm:w-[360px] [&>*:nth-last-child(1)]:border-none bg-white border border-white absolute top-[37px] right-0 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all duration-300 `}
                  >
